...
const NAV_ITEMS = [
  ...
  { key: "analytics", href: "analytics.html", label: "Analytics", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", roles: ["student", "teacher", "admin"] },
  ...
  const sidebarHtml = `
    <aside class="hidden lg:flex flex-col w-64 shrink-0 h-screen sticky top-0 glass border-r px-4 py-6" style="border-color:var(--border)">
      <a href="dashboard.html" class="flex items-center gap-2 px-2 mb-8">
        ...
        <span class="font-extrabold text-lg tracking-tight">Attendify<span class="gradient-text">AI</span></span>
      </a>
